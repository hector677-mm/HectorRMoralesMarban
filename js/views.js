        ...
        <section class="section">
          <div class="container section__grid">
            <div class="section__head">
              ...
              <img class="section__media" src="assets/img/galeria-2.jpg" alt="Héctor Morales" loading="lazy" />
            </div>
          ...
          <div class="container">
            ...
            <div class="about">
              ...
              <figure class="about__media">
                <img src="assets/img/galeria-3.jpg" alt="Héctor Morales" loading="lazy" />
              </figure>
            </div>
          </div>
        </section>`;
        ...
        <section class="section contacto">
          <div class="container contacto__inner">
            ...
            <div class="contacto__grid">
              ...
              <a class="ccard" href="https://wa.me/525531185556" target="_blank" rel="noopener">
                <span class="ccard__icon" aria-hidden="true">
              ...
              <a class="ccard" href="https://www.linkedin.com/in/hrmoralesm" target="_blank" rel="noopener">
                <span class="ccard__icon" aria-hidden="true">
